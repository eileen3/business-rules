        ...
        self.assertEqual(all_data.get("variable_type_operators"),
                         {'boolean': [{'input_type': 'none',
                            ...
                            {'input_type': 'none',
                             'label': 'Is True',
                             'name': 'is_true'}],
                           'numeric': [{'input_type': 'numeric', 'name': 'equal_to', 'label': 'Equal To'},
                                       {'input_type': 'numeric', 'name': 'greater_than', 'label': 'Greater Than'},
                                       {'input_type': 'numeric', 'name': 'greater_than_or_equal_to', 'label': 'Greater Than Or Equal To'},
                                       {'input_type': 'numeric', 'name': 'less_than', 'label': 'Less Than'},
                                       {'input_type': 'numeric', 'name': 'less_than_or_equal_to', 'label': 'Less Than Or Equal To'},
                                       {'input_type': 'numeric', 'name': 'not_within', 'label': 'Not Within'},
                                       {'input_type': 'numeric', 'name': 'within', 'label': 'Within'}],
